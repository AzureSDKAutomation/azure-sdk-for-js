...
class NetworkManagementClient extends NetworkManagementClientContext {
  ...
  networkManagerCommits: operations.NetworkManagerCommits;
  networkManagerDeploymentStatus: operations.NetworkManagerDeploymentStatusOperations;
  effectiveVirtualNetworks: operations.EffectiveVirtualNetworks;
  activeConfigurations: operations.ActiveConfigurations;
  connectivityConfigurations: operations.ConnectivityConfigurations;
  effectiveConfigurations: operations.EffectiveConfigurations;
  networkGroups: operations.NetworkGroups;
  securityConfigurations: operations.SecurityConfigurations;
  adminRules: operations.AdminRules;
  userRules: operations.UserRules;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.NetworkManagementClientOptions) {
    ...
    this.networkManagerCommits = new operations.NetworkManagerCommits(this);
    this.networkManagerDeploymentStatus = new operations.NetworkManagerDeploymentStatusOperations(this);
    this.effectiveVirtualNetworks = new operations.EffectiveVirtualNetworks(this);
    ...
    this.effectiveConfigurations = new operations.EffectiveConfigurations(this);
    ...
    this.adminRules = new operations.AdminRules(this);
    this.userRules = new operations.UserRules(this);
