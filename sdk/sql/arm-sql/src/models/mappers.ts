...
export const HybridLink: msRest.CompositeMapper = {
  serializedName: "HybridLink",
  type: {
    name: "Composite",
    className: "HybridLink",
    modelProperties: {
      ...ProxyResource.type.modelProperties,
      targetDatabase: {
...
export const HybridLinkListResult: msRest.CompositeMapper = {
  serializedName: "HybridLinkListResult",
  type: {
    name: "Composite",
    className: "HybridLinkListResult",
    modelProperties: {
      value: {
        readOnly: true,
        serializedName: "",
