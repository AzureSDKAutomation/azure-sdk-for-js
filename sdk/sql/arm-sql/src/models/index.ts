 ...
 */
export interface HybridLink extends ProxyResource {
  /**
  ...
  /**
   * The replication mode of hybrid link. Parameter will be ignored during link creation. Possible
...
/**
 * @interface
 * A list of hybrid links in instance.
 * @extends Array<HybridLink>
 */
export interface HybridLinkListResult extends Array<HybridLink> {
  /**
   * Link to retrieve next page of results.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Contains response data for the listByInstance operation.
 */
export type HybridLinksListByInstanceResponse = HybridLinkListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: HybridLinkListResult;
    };
};
 ...
 * Contains response data for the get operation.
 */
export type HybridLinksGetResponse = HybridLink & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type HybridLinksCreateOrUpdateResponse = HybridLink & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type HybridLinksDeleteMethodResponse = HybridLink & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type HybridLinksBeginCreateOrUpdateResponse = HybridLink & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type HybridLinksBeginDeleteMethodResponse = HybridLink & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listByInstanceNext operation.
 */
export type HybridLinksListByInstanceNextResponse = HybridLinkListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
