 ...
 * @enum {string}
 */
export type AlertRuleKinds = 'Scheduled' | 'MicrosoftSecurityIncidentCreation' | 'Fusion';
 ...
 * @enum {string}
 */
export type DataConnectorKinds = 'AzureActiveDirectory' | 'AzureSecurityCenter' | 'MicrosoftCloudAppSecurity' | 'ThreatIntelligence' | 'Office365' | 'AmazonWebServicesCloudTrail' | 'AzureAdvancedThreatProtection' | 'MicrosoftDefenderAdvancedThreatProtection';
