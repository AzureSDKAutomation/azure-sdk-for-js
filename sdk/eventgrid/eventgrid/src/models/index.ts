 ...
 */
export interface AcsChatMessageEventInThreadBaseProperties extends AcsChatEventInThreadBaseProperties {
  /**
   * The chat message id
   */
  messageId?: string;
 ...
 */
export interface AcsChatMessageReceivedInThreadEventData extends AcsChatMessageEventInThreadBaseProperties {
  /**
   * The body of the chat message
   */
  messageBody?: string;
 ...
 */
export interface AcsChatMessageEditedInThreadEventData extends AcsChatMessageEventInThreadBaseProperties {
  /**
   * The body of the chat message
   */
  messageBody?: string;
 ...
 */
export interface AcsChatMessageDeletedInThreadEventData extends AcsChatMessageEventInThreadBaseProperties {
  /**
   * The time at which the message was deleted
   */
  deleteTime?: Date;
...
export interface MicrosoftTeamsUserIdentifierModel {
  ...
  isAnonymous?: boolean;
  /**
   * The cloud that the Microsoft Teams user belongs to. By default 'public' if missing. Possible
   * values include: 'public', 'dod', 'gcch'
   */
  cloud?: CommunicationCloudEnvironmentModel;
}

/**
 * Identifies a participant in Azure Communication services. A participant is, for example, a phone
 * number or an Azure communication user. This model must be interpreted as a union: Apart from
 ...
 * Schema of common properties of all chat thread events
 */
export interface AcsChatThreadEventInThreadBaseProperties extends AcsChatEventInThreadBaseProperties {
  /**
   * The original creation time of the thread
   */
  createTime?: Date;
 ...
 * Microsoft.Communication.ChatThreadCreatedWithUser event.
 */
export interface AcsChatThreadCreatedEventData extends AcsChatThreadEventInThreadBaseProperties {
  /**
   * The communication identifier of the user who created the thread
   */
  createdByCommunicationIdentifier?: CommunicationIdentifierModel;
 ...
 */
export interface AcsChatThreadDeletedEventData extends AcsChatThreadEventInThreadBaseProperties {
  /**
   * The communication identifier of the user who deleted the thread
   */
  deletedByCommunicationIdentifier?: CommunicationIdentifierModel;
 ...
 */
export interface AcsChatThreadPropertiesUpdatedEventData extends AcsChatThreadEventInThreadBaseProperties {
  /**
   * The communication identifier of the user who updated the thread properties
   */
  editedByCommunicationIdentifier?: CommunicationIdentifierModel;
 ...
 */
export interface AcsChatParticipantAddedToThreadWithUserEventData extends AcsChatThreadEventBaseProperties {
  /**
 ...
 */
export interface AcsChatParticipantRemovedFromThreadWithUserEventData extends AcsChatThreadEventBaseProperties {
  /**
...
/**
 * Schema of the Data property of an EventGridEvent for an
 * Microsoft.Communication.ChatParticipantAddedToThread event.
 */
export interface AcsChatParticipantAddedToThreadEventData extends AcsChatEventInThreadBaseProperties {
  /**
   * The time at which the user was added to the thread
   */
  time?: Date;
...
/**
 * Schema of the Data property of an EventGridEvent for an
 * Microsoft.Communication.ChatParticipantRemovedFromThread event.
 */
export interface AcsChatParticipantRemovedFromThreadEventData extends AcsChatEventInThreadBaseProperties {
  /**
   * The time at which the user was removed to the thread
   */
  time?: Date;
...
/**
 * Schema for all properties for Recording Storage Ino properties.
 */
export interface AcsRecordingChunkInfoProperties {
  /**
 ...
 * Schema for all properties for Recording Storage Ino properties.
 */
export interface AcsRecordingStorageInfoProperties {
  /**
 ...
 * Possible values include: 'public', 'dod', 'gcch'
 * @readonly
 * @enum {string}
 */
