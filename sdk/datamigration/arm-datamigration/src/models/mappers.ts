...
export const MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput: msRest.CompositeMapper = {
  serializedName: "MigratePostgreSqlAzureDbForPostgreSqlSyncDatabaseTableInput",
  type: {
    name: "Composite",
