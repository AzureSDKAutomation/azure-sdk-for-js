 ...
 */
export interface ManagedPrivateEndpoint extends BaseResource {
  /**
   * Fully qualified resource Id for the resource. Ex -
   * /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
 ...
 * @extends Array<ManagedPrivateEndpoint>
 */
export interface ManagedPrivateEndpointListResponse extends Array<ManagedPrivateEndpoint> {
  /**
   * The link to the next page of results, if any remaining results exist.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Contains response data for the listByWorkspace operation.
 */
export type ManagedPrivateEndpointsListByWorkspaceResponse = ManagedPrivateEndpointListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listByWorkspaceNext operation.
 */
export type ManagedPrivateEndpointsListByWorkspaceNextResponse = ManagedPrivateEndpointListResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
