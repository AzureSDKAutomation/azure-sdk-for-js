...
export const ManagedPrivateEndpointConnectionState: msRest.CompositeMapper = {
  serializedName: "ManagedPrivateEndpointConnectionState",
  type: {
    name: "Composite",
...
export const ManagedPrivateEndpoint: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      isReserved: {
        readOnly: true,
        serializedName: "properties.isReserved",
        type: {
          name: "Boolean"
        }
      },
