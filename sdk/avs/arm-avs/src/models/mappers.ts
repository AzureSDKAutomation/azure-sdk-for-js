...
export const NetAppVolumeProperties: msRest.CompositeMapper = {
  serializedName: "NetAppVolumeProperties",
  type: {
    name: "Composite",
    className: "NetAppVolumeProperties",
    modelProperties: {
      nfsProviderIp: {
...
export const DiskPoolVolumeProperties: msRest.CompositeMapper = {
  serializedName: "DiskPoolVolumeProperties",
  type: {
    name: "Composite",
    className: "DiskPoolVolumeProperties",
    modelProperties: {
      endpoints: {
        serializedName: "endpoints",
        type: {
