 ...
 */
export interface NetAppVolumeProperties extends BaseResource {
  /**
 ...
 */
export interface DiskPoolVolumeProperties extends BaseResource {
  /**
...
export interface Datastore extends Resource {
   ...
   */
  netAppVolume?: NetAppVolumeProperties;
  /**
   * Resource ID of the iSCSI target from a Storage Pool and LUN to be used
   */
  diskPoolVolume?: DiskPoolVolumeProperties;
}
 ...
 * @enum {string}
 */
export type DatastoreProvisioningState = 'Succeeded' | 'Failed' | 'Cancelled' | 'Deleting' | 'Updating';
 ...
 */
export type DatastoresBeginCreateResponse = Datastore & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
