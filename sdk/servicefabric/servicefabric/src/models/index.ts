...
/**
 * Describes the policy to be used for placement of a Service Fabric service allowing multiple
 * stateless instances of a partition of the service to be placed on a node.
 */
export interface ServicePlacementAllowMultipleStatelessInstancesOnNodePolicyDescription {
  ...
  /**
   * Holdover from other policy descriptions, not used for this policy, values are ignored by
   * runtime. Keeping it for any backwards-compatibility with clients.
   */
  domainName?: string;
}
...
export interface StatelessServiceDescription {
  ...
  /**
   * When a stateless instance goes down, this timer starts. When it expires Service Fabric will
   * create a new instance on any node in the cluster.
