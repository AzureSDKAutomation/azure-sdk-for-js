...
export class MetricAlerts {
   ...
   * @param ruleName The name of the rule.
   * @param [options] The optional parameters
   * @returns Promise<Models.MetricAlertsGetQuotaResponse>
   */
  getQuota(resourceGroupName: string, ruleName: string, options?: msRest.RequestOptionsBase): Promise<Models.MetricAlertsGetQuotaResponse>;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param ruleName The name of the rule.
   * @param callback The callback
   */
  getQuota(resourceGroupName: string, ruleName: string, callback: msRest.ServiceCallback<Models.MetricAlertsQuota>): void;
  /**
   * @param resourceGroupName The name of the resource group.
   * @param ruleName The name of the rule.
   * @param options The optional parameters
   * @param callback The callback
   */
  getQuota(resourceGroupName: string, ruleName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.MetricAlertsQuota>): void;
  getQuota(resourceGroupName: string, ruleName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.MetricAlertsQuota>, callback?: msRest.ServiceCallback<Models.MetricAlertsQuota>): Promise<Models.MetricAlertsGetQuotaResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        ruleName,
      ...
      getQuotaOperationSpec,
      callback) as Promise<Models.MetricAlertsGetQuotaResponse>;
  }
}
...
const getQuotaOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/metricAlerts/{ruleName}/quota",
  urlParameters: [
    Parameters.subscriptionId,
    Parameters.resourceGroupName,
    Parameters.ruleName
  ...
  responses: {
    200: {
      bodyMapper: Mappers.MetricAlertsQuota
    },
    default: {
      bodyMapper: Mappers.ErrorResponse
    }
