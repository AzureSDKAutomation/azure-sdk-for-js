...
export const MetricAlertsQuota: msRest.CompositeMapper = {
  serializedName: "MetricAlertsQuota",
  type: {
    name: "Composite",
    className: "MetricAlertsQuota",
    modelProperties: {
      maxAlertRulesPerSubscription: {
        required: true,
        serializedName: "maxAlertRulesPerSubscription",
        type: {
          name: "Number"
        }
      },
      maxTimeSeriesPerAlertRule: {
        required: true,
        serializedName: "maxTimeSeriesPerAlertRule",
        type: {
          name: "Number"
        }
      }
