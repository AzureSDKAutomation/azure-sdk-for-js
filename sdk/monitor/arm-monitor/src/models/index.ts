...
/**
 * Contains response data for the getQuota operation.
 */
export type MetricAlertsGetQuotaResponse = MetricAlertsQuota & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
