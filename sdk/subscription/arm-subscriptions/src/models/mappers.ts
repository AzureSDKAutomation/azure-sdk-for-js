...
export const SubscriptionAliasRedeemResponse: msRest.CompositeMapper = {
  serializedName: "SubscriptionAliasRedeemResponse",
  type: {
    name: "Composite",
    className: "SubscriptionAliasRedeemResponse",
    modelProperties: {
      subscriptionId: {
        readOnly: true,
        serializedName: "subscriptionId",
