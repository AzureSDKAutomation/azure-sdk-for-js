 ...
 */
export interface SubscriptionAliasRedeemResponse {
  /**
   * Newly created subscription Id.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
/**
 * Contains response data for the redeemStatus operation.
 */
export type SubscriptionsRedeemStatusResponse = SubscriptionAliasRedeemResponse & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: SubscriptionAliasRedeemResponse;
    };
};
