...
export class Subscriptions {
   ...
   */
  redeem(subscriptionId: string, options?: msRest.RequestOptionsBase): Promise<Models.SubscriptionsRedeemResponse> {
    return this.beginRedeem(subscriptionId,options)
   ...
   * @param subscriptionId Subscription Id.
   * @param [options] The optional parameters
   * @returns Promise<Models.SubscriptionsRedeemStatusResponse>
   */
  redeemStatus(subscriptionId: string, options?: msRest.RequestOptionsBase): Promise<Models.SubscriptionsRedeemStatusResponse>;
  /**
   * @param subscriptionId Subscription Id.
   * @param callback The callback
   */
  redeemStatus(subscriptionId: string, callback: msRest.ServiceCallback<Models.SubscriptionAliasRedeemResponse>): void;
  /**
   * @param subscriptionId Subscription Id.
   * @param options The optional parameters
   * @param callback The callback
   */
  redeemStatus(subscriptionId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SubscriptionAliasRedeemResponse>): void;
  redeemStatus(subscriptionId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SubscriptionAliasRedeemResponse>, callback?: msRest.ServiceCallback<Models.SubscriptionAliasRedeemResponse>): Promise<Models.SubscriptionsRedeemStatusResponse> {
    return this.client.sendOperationRequest(
      {
        subscriptionId,
        options
      },
      redeemStatusOperationSpec,
      callback) as Promise<Models.SubscriptionsRedeemStatusResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginRedeem(subscriptionId: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        subscriptionId,
        options
...
const redeemStatusOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  ...
  responses: {
    200: {
      bodyMapper: Mappers.SubscriptionAliasRedeemResponse
    },
    default: {
      bodyMapper: Mappers.ErrorResponseBody
    }
