...
class SecurityAndComplianceClient extends SecurityAndComplianceClientContext {
  // Operation groups
   ...
   */
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.SecurityAndComplianceClientOptions) {
...
export {
  ...
  SecurityAndComplianceClientContext,
  Models as SecurityAndComplianceModels,
  Mappers as SecurityAndComplianceMappers
};
