...
/**
 * An interface representing SecurityAndComplianceClientOptions.
 */
export interface SecurityAndComplianceClientOptions extends AzureServiceClientOptions {
  baseUri?: string;
}
 ...
 * @interface
 * A list of service description objects with a next link.
 * @extends Array<PrivateLinkServicesForMIPPolicySyncDescription>
 */
export interface PrivateLinkServicesForMIPPolicySyncDescriptionListResult extends Array<PrivateLinkServicesForMIPPolicySyncDescription> {
  /**
   * The link used to get the next page of service description objects.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
