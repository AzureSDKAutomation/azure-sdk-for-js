...
export interface BlobContainer extends AzureEntityResource {
  ...
  /**
   * This is an immutable property, when set to true enables version level worm at the container
   * level.
   */
  enabled?: boolean;
  /**
   * Returns the date and time the version level worm was enabled.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly timeStamp?: Date;
  /**
   * This property denotes the container level worm to version level worm migration state. Possible
   * values include: 'InProgress', 'Completed', 'Abort'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Possible values include: 'InProgress', 'Completed', 'Abort'
 * @readonly
 * @enum {string}
 */
export type MigrationState = 'InProgress' | 'Completed' | 'Abort';
