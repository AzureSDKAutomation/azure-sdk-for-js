...
export const BlobContainer: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      enabled: {
        serializedName: "properties.versionLevelWorm.enabled",
        type: {
          name: "Boolean"
        }
      },
      timeStamp: {
        readOnly: true,
        serializedName: "properties.versionLevelWorm.timeStamp",
        type: {
          name: "DateTime"
        }
      },
      migrationState: {
        readOnly: true,
        serializedName: "properties.versionLevelWorm.migrationState",
        type: {
          name: "String"
        }
      }
