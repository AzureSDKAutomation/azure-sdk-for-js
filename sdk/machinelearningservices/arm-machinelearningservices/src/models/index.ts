...
export interface CodeVersionResource extends BaseResource {
  ...
  path?: string;
  /**
   * How this asset was generated. Possible values include: 'User', 'System'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly generatedBy?: AssetGenerator;
  /**
...
/**
 * An interface representing UserAssignedIdentityMeta.
 */
...
/**
 * An interface representing ResourceIdentityInArm.
 */
export interface ResourceIdentityInArm {
  type?: string;
  principalId?: string;
  tenantId?: string;
  userAssignedIdentities?: { [propertyName: string]: UserAssignedIdentityMeta };
}

/**
 * An interface representing OnlineDeploymentScaleSettings.
 */
export interface OnlineDeploymentScaleSettings {
  minimum?: number;
  maximum?: number;
...
/**
 * Contains the possible cases for DeploymentConfigurationBase.
 */
export type DeploymentConfigurationBaseUnion = DeploymentConfigurationBase | AksDeploymentConfiguration | ManagedDeploymentConfiguration;
...
/**
 * An interface representing AksDeploymentConfiguration.
 */
export interface AksDeploymentConfiguration {
  /**
   * Polymorphic Discriminator
   */
  computeType: "AKS";
 ...
 */
export interface ManagedDeploymentConfiguration {
  /**
   * Polymorphic Discriminator
   */
  computeType: "Managed";
   ...
   */
  osType?: OSTypes;
  readinessProbeRequirements?: LivenessProbeRequirements;
}

/**
 * Contains the possible cases for AssetReferenceBase.
 */
...
/**
 * An interface representing IdAssetReference.
 */
export interface IdAssetReference {
  /**
   * Polymorphic Discriminator
   */
  referenceType: "Id";
...
/**
 * An interface representing DataPathAssetReference.
 */
export interface DataPathAssetReference {
  /**
   * Polymorphic Discriminator
   */
...
/**
 * An interface representing OutputPathAssetReference.
 */
export interface OutputPathAssetReference {
  /**
   * Polymorphic Discriminator
   */
...
/**
 * An interface representing OnlineDeploymentTrackedResource.
 */
export interface OnlineDeploymentTrackedResource extends BaseResource {
  tags?: { [propertyName: string]: string };
  location: string;
  kind?: string;
  identity?: ResourceIdentityInArm;
  /**
   * The resource URL of the entity (not URL encoded).
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
   ...
   */
  readonly type?: string;
  scaleSettings?: OnlineDeploymentScaleSettings;
  deploymentConfiguration: DeploymentConfigurationBaseUnion;
  /**
   * Provisioning state for the endpoint deployment. Possible values include: 'Creating',
   * 'Deleting', 'Scaling', 'Updating', 'Succeeded', 'Failed', 'Canceled'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
   ...
   */
  properties?: { [propertyName: string]: string };
  modelReference: AssetReferenceBaseUnion;
  /**
...
/**
 * An interface representing PartialOnlineDeploymentPartialTrackedResource.
 */
...
/**
 * Contains the possible cases for ComputeConfiguration.
 */
export type ComputeConfigurationUnion = ComputeConfiguration | AksComputeConfiguration | ManagedComputeConfiguration | AzureMLComputeConfiguration;
...
/**
 * An interface representing AksComputeConfiguration.
 */
export interface AksComputeConfiguration {
  /**
   * Polymorphic Discriminator
   */
  computeType: "AKS";
...
/**
 * An interface representing ManagedComputeConfiguration.
 */
...
/**
 * An interface representing AzureMLComputeConfiguration.
 */
export interface AzureMLComputeConfiguration {
  /**
   * Polymorphic Discriminator
   */
  computeType: "AzureMLCompute";
}

/**
 * An interface representing OnlineEndpointTrackedResource.
 */
export interface OnlineEndpointTrackedResource extends BaseResource {
  tags?: { [propertyName: string]: string };
  location: string;
  kind?: string;
  identity?: ResourceIdentityInArm;
  ...
  readonly type?: string;
  /**
   * State of endpoint provisioning. Possible values include: 'Creating', 'Deleting', 'Succeeded',
   * 'Failed', 'Updating', 'Canceled'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  ...
  computeConfiguration: ComputeConfigurationUnion;
  /**
   * Endpoint URI
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
/**
 * An interface representing PartialOnlineEndpointPartialTrackedResource.
 */
...
/**
 * An interface representing EndpointAuthKeys.
 */
...
export interface OnlineEndpointsListOptionalParams extends msRest.RequestOptionsBase {
   ...
   * key or tags key=value. Example: tagKey1,tagKey2,tagKey3=value3 .
   */
  tags?: string;
  /**
 ...
 * @extends Array<OnlineDeploymentTrackedResource>
 */
export interface OnlineDeploymentTrackedResourceArmPaginatedResult extends Array<OnlineDeploymentTrackedResource> {
  nextLink?: string;
}
 ...
 * @extends Array<OnlineEndpointTrackedResource>
 */
export interface OnlineEndpointTrackedResourceArmPaginatedResult extends Array<OnlineEndpointTrackedResource> {
  nextLink?: string;
}
 ...
 * @enum {string}
 */
export type ScaleTypeMode = 'Automatic' | 'Manual' | 'None';
 ...
 * @enum {string}
 */
export type OSTypes = 'Linux' | 'Windows';
 ...
 * @enum {string}
 */
export type DeploymentProvisioningState = 'Creating' | 'Deleting' | 'Scaling' | 'Updating' | 'Succeeded' | 'Failed' | 'Canceled';
 ...
 * Possible values include: 'Creating', 'Deleting', 'Succeeded', 'Failed', 'Updating', 'Canceled'
 * @readonly
 * @enum {string}
 */
export type EndpointProvisioningState = 'Creating' | 'Deleting' | 'Succeeded' | 'Failed' | 'Updating' | 'Canceled';
...
export type OnlineDeploymentsListResponse = OnlineDeploymentTrackedResourceArmPaginatedResult & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: OnlineDeploymentTrackedResourceArmPaginatedResult;
    };
};
 ...
 * Contains response data for the deleteMethod operation.
 */
export type OnlineDeploymentsDeleteResponse = OnlineDeploymentsDeleteHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineDeploymentsDeleteHeaders;
    };
};
 ...
 * Contains response data for the get operation.
 */
export type OnlineDeploymentsGetResponse = OnlineDeploymentTrackedResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: OnlineDeploymentTrackedResource;
    };
};
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type OnlineDeploymentsCreateOrUpdateResponse = OnlineDeploymentTrackedResource & OnlineDeploymentsCreateOrUpdateHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineDeploymentsCreateOrUpdateHeaders;
 ...
 * Contains response data for the update operation.
 */
export type OnlineDeploymentsUpdateResponse = OnlineDeploymentTrackedResource & OnlineDeploymentsUpdateHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineDeploymentsUpdateHeaders;
...
export type OnlineEndpointsListResponse = OnlineEndpointTrackedResourceArmPaginatedResult & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: OnlineEndpointTrackedResourceArmPaginatedResult;
    };
};
 ...
 * Contains response data for the deleteMethod operation.
 */
export type OnlineEndpointsDeleteResponse = OnlineEndpointsDeleteHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineEndpointsDeleteHeaders;
    };
};
 ...
 * Contains response data for the get operation.
 */
export type OnlineEndpointsGetResponse = OnlineEndpointTrackedResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: OnlineEndpointTrackedResource;
    };
};
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type OnlineEndpointsCreateOrUpdateResponse = OnlineEndpointTrackedResource & OnlineEndpointsCreateOrUpdateHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineEndpointsCreateOrUpdateHeaders;
 ...
 * Contains response data for the update operation.
 */
export type OnlineEndpointsUpdateResponse = OnlineEndpointTrackedResource & OnlineEndpointsUpdateHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineEndpointsUpdateHeaders;
 ...
 */
export type OnlineEndpointsRegenerateKeysResponse = OnlineEndpointsRegenerateKeysHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The parsed HTTP response headers.
       */
      parsedHeaders: OnlineEndpointsRegenerateKeysHeaders;
    };
};
