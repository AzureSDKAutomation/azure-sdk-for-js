...
export class CodeVersions {
   ...
   */
  createOrUpdate(name: string, version: string, resourceGroupName: string, workspaceName: string, body: Models.CodeVersionResource, options?: msRest.RequestOptionsBase): Promise<Models.CodeVersionsCreateOrUpdateResponse>;
  /**
   * @param name Container name.
   * @param version Version identifier.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   ...
   */
  createOrUpdate(name: string, version: string, resourceGroupName: string, workspaceName: string, body: Models.CodeVersionResource, callback: msRest.ServiceCallback<Models.CodeVersionResource>): void;
  /**
   * @param name Container name.
   * @param version Version identifier.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   ...
   * @param callback The callback
   */
  createOrUpdate(name: string, version: string, resourceGroupName: string, workspaceName: string, body: Models.CodeVersionResource, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.CodeVersionResource>): void;
  createOrUpdate(name: string, version: string, resourceGroupName: string, workspaceName: string, body: Models.CodeVersionResource, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.CodeVersionResource>, callback?: msRest.ServiceCallback<Models.CodeVersionResource>): Promise<Models.CodeVersionsCreateOrUpdateResponse> {
