...
export class EnvironmentContainers {
   ...
   */
  createOrUpdate(name: string, resourceGroupName: string, workspaceName: string, body: Models.EnvironmentContainerResource, options?: msRest.RequestOptionsBase): Promise<Models.EnvironmentContainersCreateOrUpdateResponse>;
  /**
   * @param name Container name.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param workspaceName Name of Azure Machine Learning workspace.
   ...
   */
  createOrUpdate(name: string, resourceGroupName: string, workspaceName: string, body: Models.EnvironmentContainerResource, callback: msRest.ServiceCallback<Models.EnvironmentContainerResource>): void;
  /**
   * @param name Container name.
   * @param resourceGroupName The name of the resource group. The name is case insensitive.
   * @param workspaceName Name of Azure Machine Learning workspace.
   ...
   * @param callback The callback
   */
  createOrUpdate(name: string, resourceGroupName: string, workspaceName: string, body: Models.EnvironmentContainerResource, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.EnvironmentContainerResource>): void;
  createOrUpdate(name: string, resourceGroupName: string, workspaceName: string, body: Models.EnvironmentContainerResource, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.EnvironmentContainerResource>, callback?: msRest.ServiceCallback<Models.EnvironmentContainerResource>): Promise<Models.EnvironmentContainersCreateOrUpdateResponse> {
...
const createOrUpdateOperationSpec: msRest.OperationSpec = {
  ...
  requestBody: {
    parameterPath: "body",
    mapper: {
      ...Mappers.EnvironmentContainerResource,
      required: true
    }
  },
  responses: {
