...
export class MachineLearningCompute {
  ...
  restart(resourceGroupName: string, workspaceName: string, computeName: string, options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse> {
    return this.beginRestart(resourceGroupName,workspaceName,computeName,options)
      .then(lroPoller => lroPoller.pollUntilFinished());
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginRestart(resourceGroupName: string, workspaceName: string, computeName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        workspaceName,
