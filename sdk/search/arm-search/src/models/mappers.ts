...
export const NonCmkEncryptedResource: msRest.CompositeMapper = {
  serializedName: "NonCmkEncryptedResource",
  type: {
    name: "Composite",
    className: "NonCmkEncryptedResource",
    modelProperties: {
      type: {
        serializedName: "type",
        type: {
...
export const EncryptionWithCmk: msRest.CompositeMapper = {
  serializedName: "EncryptionWithCmk",
  type: {
    name: "Composite",
    ...
    modelProperties: {
      ...
      nonCmkEncryptedResources: {
        readOnly: true,
        serializedName: "nonCmkEncryptedResources",
        type: {
          name: "Sequence",
          element: {
            type: {
