 ...
 */
export interface NonCmkEncryptedResource {
  /**
   * Describes type of resource (.i.e. index, indexer, skillset, synonym map and debug session) not
   * encrypted by customer managed keys.
   */
  type?: string;
  /**
...
export interface EncryptionWithCmk {
  /**
   * Enforcement state of encryption with customer managed keys. Can be enabled, disabled, or
   * unspecified. Possible values include: 'unspecified', 'enabled', 'disabled'
   */
  enforcement?: EncryptionEnforcementStatus;
  /**
   * The list of Non Cmk encrypted resource.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly nonCmkEncryptedResources?: NonCmkEncryptedResource[];
}
...
export interface SearchService extends TrackedResource {
  ...
  /**
   * Details related to encrypting resources (.i.e. index, indexer, skillset, synonym map and debug
   * session) with customer managed keys by the Azure Cognitive Search service.
   */
 ...
 * Possible values include: 'unspecified', 'enabled', 'disabled'
 * @readonly
 * @enum {string}
 */
export type EncryptionEnforcementStatus = 'unspecified' | 'enabled' | 'disabled';
