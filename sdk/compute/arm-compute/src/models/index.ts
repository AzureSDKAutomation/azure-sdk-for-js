...
export interface OSDisk {
  ...
  /**
   * Specifices whether OS Disk should be deleted or detached upon VM deletion. An ephemeral OS
   * Disk can not DeleteOption as Delete.<br><br> Possible values: <br><br> **Delete** If this
   * value is used, the OS disk is deleted when VM is deleted.<br><br> **Detach** If this value is
   * used, the os disk is retained even after VM is deleted. Possible values include: 'Delete',
   * 'Detach'
   */
...
export interface DataDisk {
  ...
  /**
   * Specifices whether data disk should be deleted or detached upon VM deletion.<br><br> Possible
   * values: <br><br> **Delete** If this value is used, the data disk is deleted when VM is
   * deleted.<br><br> **Detach** If this value is used, the data disk is retained even after VM is
