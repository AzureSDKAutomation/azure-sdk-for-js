...
export interface RestorePointSourceVMStorageProfile {
  /**
   * Gets the OS disk of the VM captured at the time of creation of restore point.
   */
  osDisk?: RestorePointSourceVMOSDisk;
  /**
   * Gets the data disks of the VM captured at the time of creation of restore point.
   */
...
/**
 * Describes the properties of a Virtual Machine from which the restore point was created.
 */
 ...
 */
export interface RestorePoint extends BaseResource {
  /**
 ...
 * Contains response data for the createOrUpdate operation.
 */
export type RestorePointsCreateOrUpdateResponse = RestorePoint & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type RestorePointsBeginCreateOrUpdateResponse = RestorePoint & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
