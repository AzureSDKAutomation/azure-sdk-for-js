...
export class RestorePoints {
   ...
   */
  create(resourceGroupName: string, restorePointCollectionName: string, restorePointName: string, parameters: Models.RestorePointCreate, options?: msRest.RequestOptionsBase): Promise<Models.RestorePointsCreateResponse> {
   ...
   */
  beginCreate(resourceGroupName: string, restorePointCollectionName: string, restorePointName: string, parameters: Models.RestorePointCreate, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
