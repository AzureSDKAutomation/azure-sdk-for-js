...
export class RestorePoints {
   ...
   * @returns Promise<Models.RestorePointsCreateOrUpdateResponse>
   */
  createOrUpdate(resourceGroupName: string, restorePointCollectionName: string, restorePointName: string, parameters: Models.RestorePoint, options?: msRest.RequestOptionsBase): Promise<Models.RestorePointsCreateOrUpdateResponse> {
    return this.beginCreateOrUpdate(resourceGroupName,restorePointCollectionName,restorePointName,parameters,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.RestorePointsCreateOrUpdateResponse>;
  }
   ...
   */
  beginCreateOrUpdate(resourceGroupName: string, restorePointCollectionName: string, restorePointName: string, parameters: Models.RestorePoint, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
