...
export class PotentialOutages {
   ...
   */
  get(outageId: string, options?: msRest.RequestOptionsBase): Promise<Models.PotentialOutagesGetResponse>;
  /**
   * @param outageId The id of the potential outage.
   * @param callback The callback
   */
  get(outageId: string, callback: msRest.ServiceCallback<Models.PotentialOutagesGetResult>): void;
  /**
   * @param outageId The id of the potential outage.
   * @param options The optional parameters
   * @param callback The callback
   */
  get(outageId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.PotentialOutagesGetResult>): void;
  get(outageId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.PotentialOutagesGetResult>, callback?: msRest.ServiceCallback<Models.PotentialOutagesGetResult>): Promise<Models.PotentialOutagesGetResponse> {
...
const getOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "providers/Microsoft.ResourceHealth/potentialOutages/{outageId}",
  urlParameters: [
    Parameters.outageId
  ],
  queryParameters: [
