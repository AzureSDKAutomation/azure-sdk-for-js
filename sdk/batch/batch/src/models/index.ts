...
export interface TaskConstraints {
   ...
   * unless the Compute Node is removed or the Job is deleted. Note that when using smaller VM
   * sizes, task retention should be kept short to limit resource usage.
   */
...
export interface JobReleaseTask {
   ...
   * is removed or the Job is deleted. Note that when using smaller VM sizes, task retention should
   * be kept short to limit resource usage.
   */
  retentionTime?: string;
  /**
