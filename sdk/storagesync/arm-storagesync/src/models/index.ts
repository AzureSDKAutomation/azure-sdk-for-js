 ...
 * Possible values include: 'InitialEnumerationInProgress', 'EnumerationInProgress'
 * @readonly
 * @enum {string}
 */
export type CloudEndpointChangeEnumerationActivityState = 'InitialEnumerationInProgress' | 'EnumerationInProgress';
